...
def path(energy,m,q):
    ...
    m = m*1.79e-30 # particle mass in kg
    ...
    # increase iterations for stiff functions
    solution = odeint(dpvdt,veloc_pos,time,args = (m,q,magField),mxstep = 50000000)
    antisolution = odeint(dpvdt,veloc_antipos,time,args = (m,-q,magField),mxstep = 50000000)
    return [solution,antisolution]
